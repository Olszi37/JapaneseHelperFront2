...
@Component({
  selector: 'app-kanji-learn',
  templateUrl: './kanji-learn.component.html',
  styleUrls: ['./kanji-learn.component.css', '../../app.component.css', '../learn.component.css'],
  providers: [RecordService, FlashcardService]
})
export class KanjiLearnComponent implements OnInit {
