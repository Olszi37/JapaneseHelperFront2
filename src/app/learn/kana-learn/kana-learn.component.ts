...
@Component({
  selector: 'app-kana-learn',
  templateUrl: './kana-learn.component.html',
  styleUrls: ['./kana-learn.component.css', '../../app.component.css', '../learn.component.css'],
  providers: [RecordService, FlashcardService]
})
export class KanaLearnComponent implements OnInit {

  type: string = 'KATAKANA';
